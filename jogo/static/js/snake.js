...
let estadoJogo = true;
let snake = '<img src="/static/img/snake/snake.png">';
let imgCorpo = '<img src="/static/img/snake/'+aleatorio(0,1)+'.png">'
let direcao = 1;
    ...
    if(document.querySelector('img[name="comida"]') == null){
        while (status==false){
            ...
            if(area[valor].innerHTML == ''){
                area[valor].innerHTML = '<img name="comida" src="/static/img/snake/p'+aleatorio(0,5)+'.png">';
                status=true
            }
        }
    }
...
function reiniciar(){
    imgCorpo = '<img src="/static/img/snake/'+aleatorio(0,1)+'.png">'
    direcao = 1;
    corpo = [116,115,114];
    fazerCampo();
    iniciarJogo();   
